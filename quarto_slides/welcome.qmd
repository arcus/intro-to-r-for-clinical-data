...
::: {.column width="33%"}
![](media/dino_3.jpg)
Aki DiSandro, Presenter
:::
::: {.column width="33%"}
![](media/joy.png)
Joy Payton, Presenter, Zoomologist, etc.
:::
::: {.column width="33%"}
![](media/megha.jpg)
Megha Lal, Teaching Assistant
:::
:::
...
Next, two more speakers, Aki and Joy, and our first TA, Megha.
...
::: {.column width="33%"}
![](media/dino_5.jpg)
Mary Kate Kelly, Teaching Assistant
:::
::: {.column width="33%"}
![](media/rich.png)
