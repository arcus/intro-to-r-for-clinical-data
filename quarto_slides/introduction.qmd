...
Go to <https://example.com> in your browser.  If you're not already logged in, log in to Posit.cloud.

![](media/save_copy.png){.bordered .one-third fig-align="center"}

Please click on "Save a Permanent Copy".

Click "yes" (![](media/yes_button.png){.inline-image height="2em"}) once you see something like the image below.
...
Please click the yes (![](media/yes_button.png){.inline-image height="1em"}) button in zoom to let us know you logged in successfully.
...
Click yes (![](media/yes_button.png){.inline-image height="2em"}) when you are done.
