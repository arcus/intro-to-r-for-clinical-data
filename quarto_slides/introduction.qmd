...
::: notes
Now it’s your turn to get logged into Posit.cloud and make a copy of the project for yourself, that you can change and save and work with on your own account.  **Please listen closely** to the instruction for this slide, because if you don't follow these instructions, you might accidentally prevent other people from participating today.  You **must** click the "Save a Permanent Copy", which will make a version of this project in **your** account.  If you don't do that, you'll be working in our account, and we can only have a few dozen people at a time in our account, so you'll be blocking others from participating.

Please click the thumbs up button in Teams to let us know you logged in successfully AND saved a Permanent Copy of the project.
...
When you knit the document, it will ask you for a filename to save to -- just enter "test" as the filename!
